...
class TurtleSpawnerNode(Node):
    def __init__(self):
        ...
        self.get_parameter("turtle_name_prefix", "turtle" )
        self.get_parameter("spawn_frequency", 1.0)
    ...
    def call_kill_service(self, turtle_name):
        ...
        future.add_done_callback(partial(self.callback_kill_service, request = request))

    def callback_kill_service(self, future, request):
